...
SECRET_KEY = 'django-insecure-q*@rk(1#=-y&kjnyypt)ehqcggds!mj6)o#^%ah2rsj_bj7g$g'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'proyecto_final_db',  # Nombre de la base de datos
        'USER': 'postgres',        # Usuario de PostgreSQL
        'PASSWORD': 'Eds666',  # Contraseña de PostgreSQL
